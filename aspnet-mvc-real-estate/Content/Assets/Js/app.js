...
$('.collection-galery').slick({
    slidesToShow: 3,
    prevArrow: "<button type='button' class='slick-pre-img slick-galery'><i class='fa fa-angle-left' aria-hidden='true'></i></button>",
    nextArrow: "<button type='button' class='slick-next-img slick-galery'><i class='fa fa-angle-right' aria-hidden='true'></i></button>",
    responsive: [
        {
            breakpoint: 768,
            settings: {
